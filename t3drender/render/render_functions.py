...
def render_rgb(meshes, device, resolution=(512, 512), fov=90, cameras=None, batch_size=30, verbose=False):
...
def render_depth_perspective(meshes, device, resolution=(512, 512), fov=90, cameras=None, batch_size=30, verbose=False):
    K = torch.eye(3, 3)[None]
    h, w = resolution
